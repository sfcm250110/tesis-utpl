...
public class DownloadComprobantesSriWsListener implements MessageListener {

	private static Logger log = Logger.getLogger(DownloadComprobantesSriWsListener.class);
	...
	public void onMessage(Message pMessage) {
		...
		try {
			...
			FwUtplFactory.getIntance().getComprobanteService().downloadComprobanteSriWs(messageXml);
